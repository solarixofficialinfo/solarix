...
import {
  ...
  TrendingUp, Clock, CheckCircle2, ChevronRight, MessageSquare
} from "lucide-react";
    ...
    <div className="space-y-6 font-sans">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-400">High-level customer accounts, active subscriptions, and system metrics.</p>
        </div>
        <Button onClick={() => navigate("/control-center/customers")} className="bg-blue-600 hover:bg-blue-700 font-semibold text-xs gap-1.5">
