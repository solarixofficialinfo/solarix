...
async def get_company_subscription(user=Depends(get_current_user_dep())):
    ...
    percentages = {
        ...
        "monthly_manual_imports": min(100, int((usage.get("monthly_manual_imports", 0) / max(1, limits.get("monthly_manual_imports", 1))) * 100)),
    ...
    return {
        **entitlement,
        "usage": {
            ...
            "monthly_manual_imports": usage.get("monthly_manual_imports", 0),
